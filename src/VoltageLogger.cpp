...
const String fileName = "/voltage.json";

void VoltageLogger::addNewPoint(float value)
{
    ...
    // Add new record
    if (records.size() >= settings.maxVoltagePoints)
    {
...
String VoltageLogger::getAllPoints()
{
