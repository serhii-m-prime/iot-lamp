...
const String fileName = "/humidity.json";

void HumidityLogger::addNewPoint(float value)
{
    ...
    // Add new record
    if (records.size() >= settings.maxHumidityPoints)
    {
...
String HumidityLogger::getAllPoints()
{
